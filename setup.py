...
#			os.path.abspath(os.path.join(__curdir__, 'src/bin/')),
			...
			os.path.abspath(os.path.join(__curdir__, 'src/pytis/configure.py')),
			os.path.abspath(os.path.join(__curdir__, 'src/pytis/copyright.py')),
			os.path.abspath(os.path.join(__curdir__, 'src/pytis/getip.py')),
#			os.path.abspath(os.path.join(__curdir__, 'src/pytis/__init__.py')),
#			os.path.abspath(os.path.join(__curdir__, 'src/pytis/pytis.py')),
#			os.path.abspath(os.path.join(__curdir__, 'src/pytis/.lvimrc.py')),
