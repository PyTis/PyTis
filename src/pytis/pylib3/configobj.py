    ...
    def validate(self, validator, preserve_errors=False, copy=False,
        ...
        if section is None:
            ...
            if preserve_errors:
                ...
                import validate.VdtMissingValue as VdtMissingValue
...
def fload(fname):
    ...
    Forceably load the file, same as load(fname, TRUE)
...
def load(fname, write=False):
    ...
    :write: forceably create this file if it does not exist
